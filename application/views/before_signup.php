...
<body>
    ...
    <a href="<?=base_url();?>"><img src="<?= base_url('assets/image/home_Wall.png');?>"></a>
    </div> 
        ...
        <div class="row mx-md-5">
            ...
            <div class="col">
                <div class="p-md-5 p-3 pt-4 pb-4 pt-md-5 pb-md-5 mx-3 text-center text-white float-md-right box-grey-login">
                    ...
                    with
                    <br><br>
                    <!-- <img src="<?php echo base_url("assets/img/google-logo.jpg")?>" style="width:250px; border-radius:6px;"><br><br> -->
                    ...
                    or<br><br>
                    Register Manually. <a href="<?=base_url("welcome/signup");?>">Click Here</a>
                    <br><br>
